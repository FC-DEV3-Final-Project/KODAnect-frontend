  ...
  ({ value, placeholder, onClick, onOpen, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className="flex h-[4.8rem] w-[22.3rem] items-center justify-between rounded-r3 border border-gray-60 bg-white px-p6 text-left text-b-md text-gray-90 focus:border-2 focus:border-secondary-50 mobile:h-[4rem] mobile:w-[15.6rem] mobile:text-b-sm"
        {...props}
      >
